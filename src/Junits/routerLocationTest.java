...
public class routerLocationTest {
	...
	public void locationTest1() {
		...
		list1.add(new WifiScan("27/10/2017" ,"12:34:30", "Lenovo PB2-690Y",32.742, 34.963, 39, -59, "DIRECT-A5sfgn","fc:4f:db:7e:50:a6" ,8));
		list1.add(new WifiScan("26/10/2017" ,"12:34:30", "Lenovo PB2-690Y",32.147, 34.752, 29, -40, "DIRECT-A5rtt","fc:4f:db:7e:50:a6" ,6));
