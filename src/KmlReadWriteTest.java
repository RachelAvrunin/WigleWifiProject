...
public class KmlReadWriteTest {
	...
	public void timeFilterTest() {
		...
		ArrayList<RowsRead> list2= new ArrayList<RowsRead>();
		...
		list1.add(new RowsRead("27/10/2017" ,"12:34:30", "Lenovo PB2-690Y",32.742, 34.963, 39, -59, "DIRECT-A5sfgn","fu:9f:db:7e:25:a6" ,8));
		list1.add(new RowsRead("26/10/2017" ,"12:34:30", "Lenovo PB2-690Y",32.147, 34.752, 29, -40, "DIRECT-A5rtt","fk:1f:db:7e:09:a6" ,6));
		...
		if (list1.size()==list2.size()){
			for (int i = 0; i < list1.size(); i++) {
				if(!list1.get(i).date.equals(list2.get(i).date) || 
						...
						list1.get(i).longtitude!=list2.get(i).longtitude ||
						list1.get(i).latitude!=list2.get(i).latitude || 
						list1.get(i).altitude!=list2.get(i).altitude || 
						list1.get(i).Signal!=list2.get(i).Signal || 
						!list1.get(i).SSID.equals(list2.get(i).SSID) ||
						!list1.get(i).mac.equals(list2.get(i).mac) || 
						list1.get(i).frequncy!=list2.get(i).frequncy )	
					flag=false;				
			}
		}
		else 
	...
	public void idFilterTest() {
		...
		list2.add(new RowsRead("26/10/2017" ,"15:50:20", "LG-H850",32.149, 34.752, 42, -59, "DIRECT-sAsfgn5-HP","ff:3f:db:7e:60:a6" ,14));
		list2.add(new RowsRead("27/10/2017" ,"16:16:35", "LG-H850",32.417, 34.411, 53, -70, "DIRECT-A5xvb","fn:7f:db:7e:20:a6" ,9));
		list2.add(new RowsRead("28/10/2017" ,"17:50:20", "LG-H850",32.258, 34.257, 41, -50, "DIRECT-A5khs","fe:2f:db:7e:59:a6" ,36));
		list2.add(new RowsRead("28/10/2017" ,"18:34:15", "LG-H850",32.369, 34.756, 38, -60, "DIRECT-A5dfnb","fc:1f:db:7e:72:a6" ,44));
		list2.add(new RowsRead("28/10/2017" ,"18:00:17", "LG-H850",32.147, 34.741, 40, -72, "DIRECT-A5zcvvb","fg:8f:db:7e:52:a6" ,2));
